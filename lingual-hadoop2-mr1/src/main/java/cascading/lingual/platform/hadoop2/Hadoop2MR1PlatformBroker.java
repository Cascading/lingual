...
package cascading.lingual.platform.hadoop2;
 ...
 *
 */
public class Hadoop2MR1PlatformBroker extends PlatformBroker<JobConf>
  {
  private static final Logger LOG = LoggerFactory.getLogger( Hadoop2MR1PlatformBroker.class );
  ...
  public Hadoop2MR1PlatformBroker()
    {
    }
