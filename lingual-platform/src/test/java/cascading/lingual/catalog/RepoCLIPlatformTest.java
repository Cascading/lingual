...
public class RepoCLIPlatformTest extends CLIPlatformTestCase
  ...
  public void testValidateRepoCLI() throws IOException
    ...
    initCatalog();
    int initialSize = getSchemaCatalog().getRepositoryNames().size();
    ...
    int finalSize = getSchemaCatalog().getRepositoryNames().size();
  ...
  public void testRepoCLI() throws IOException
    ...
    Collection<String> mavenRepoNames = schemaCatalog.getRepositoryNames();
    ...
    mavenRepoNames = schemaCatalog.getRepositoryNames();
