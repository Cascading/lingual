...
public class CascadingCalcConverterRule extends ConverterRule
  ...
  public CascadingCalcConverterRule()
    {
    super( CalcRel.class, CallingConvention.NONE, CascadingCallingConvention.CASCADING, "CascadingCalcRule" );
    }
  ...
  public RelNode convert( RelNode rel )
    ...
    final RelNode convertedChild =
      mergeTraitsAndConvert( calc.getTraitSet(), CascadingCallingConvention.CASCADING, calc.getChild() );
