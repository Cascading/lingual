...
[subs="attributes"]
----
> curl http://{artifactsurl}/lingual/1.1/lingual-client/install-lingual-client.sh | bash
----
...
[subs="attributes"]
----
> wget -i http://{artifactsurl}/lingual/1.1/lingual-client/latest.txt
----
...
elastic-mapreduce \
  ...
  --bootstrap-action s3://{artifactsurl}/lingual/1.1/lingual-client/install-lingual-client.sh \
...
[subs="attributes"]
----
--bootstrap-action s3://{artifactsurl}/sdk/2.5/install-cascading-sdk.sh
----
